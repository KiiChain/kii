...
type App struct {
	*baseapp.BaseApp
	...
	KiichainKeeper kiichainmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.KiichainKeeper = *kiichainmodulekeeper.NewKeeper(
		appCodec,
		keys[kiichainmoduletypes.StoreKey],
		keys[kiichainmoduletypes.MemStoreKey],
		app.GetSubspace(kiichainmoduletypes.ModuleName),
	)
	kiichainModule := kiichainmodule.NewAppModule(appCodec, app.KiichainKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		kiichainmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(kiichainmoduletypes.ModuleName)
